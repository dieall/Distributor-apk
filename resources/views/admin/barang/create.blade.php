        ...
        <form action="{{ route('admin.barang.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        <span class="absolute left-4 top-1/2 -translate-y-1/2 text-sm text-neutral-500 font-medium">Rp</span>
                        <input type="text" name="harga_mbg" value="{{ old('harga_mbg') }}" placeholder="Sama dengan harga jual jika kosong"
                    ...
                    <p class="text-neutral-400 text-xs mt-1">Harga acuan MBG untuk tampilan pelanggan; hanya diubah dari sini.</p>
