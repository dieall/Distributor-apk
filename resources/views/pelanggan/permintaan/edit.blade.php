...
<form action="{{ route('pelanggan.permintaan.update', $permintaan) }}" method="POST">
@csrf
@method('PUT')
    ...
    <div class="p-6">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div>
                ...
                <input type="text" name="no_po_customer" value="{{ old('no_po_customer', $permintaan->no_po_customer) }}" maxlength="50" placeholder="Nomor PO pembelian Anda (opsional)"
                    class="w-full px-3.5 py-2.5 rounded-lg border border-neutral-300 dark:border-neutral-500 text-sm bg-white dark:bg-neutral-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-500">
