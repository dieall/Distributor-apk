...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Header — selaras gaya cetak invoice (hijau) */
        .header { display: flex; justify-content: space-between; align-items: flex-start; padding-bottom: 10px; border-bottom: 3px solid #166534; margin-bottom: 14px; }
        ...
        .doc-title p { font-size: 11px; color: #555; margin-top: 4px; }
        ...
        thead tr th { background-color: #166534; color: #fff; font-size: 10px; text-transform: uppercase; letter-spacing: .5px; padding: 7px 10px; text-align: left; }
        ...
        tfoot tr td { padding: 8px 10px; font-size: 12px; font-weight: 700; border-top: 2px solid #166534; color: #166534; }
        ...
        /* Note */
        .note-box { background: #f0fdf4; border: 1px solid #bbf7d0; border-radius: 6px; padding: 8px 12px; margin-bottom: 16px; font-size: 11px; }
...
<div class="page">
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="td-right"><strong>{{ format_qty_id($d->jumlah) }}</strong></td>
            </tr>
            @endforeach
        </tbody>
        <tfoot>
    ...
    <p style="margin-top:20px; font-size:10px; color:#999; text-align:center;">
        Surat jalan ini dicetak pada {{ now()->format('d F Y, H:i') }} WIB &mdash; {{ $c['legal_name'] }}
    </p>
</div>
</body>
</html>
